...
function CollectionList() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Could not create collection.",
      );
    } finally {
      setSaving(false);
    }
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Could not update collection.",
      );
    } finally {
      setSaving(false);
    }
                    ...
                    >
                      <p
                        style={{
                          fontWeight: 700,
                          fontSize: 15,
                          marginBottom: col.description ? 3 : 0,
                        }}
                      >
                        {col.title}
                      </p>
